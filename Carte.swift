...
/*
var c: Carte 
try c = Carte(nom : "Archer")
print(c.getNom())
print(c.getPortee())
print(c.getDefDefensif())
//print(c.getAtt())
print(c.getDefOffensif())
print(c.getDef())
print(c.getDeg())
try c.setDeg(nbr : 2)
print(c.getDeg())
print(c.estRoi())
try c = Carte(nom : "Roi1")
print(c.estRoi())
print(c.estaSaportee(positionC : "F1", positionCible : "F3"))
print(c.estaSaportee(positionC : "A1", positionCible : "A1"))
*/
